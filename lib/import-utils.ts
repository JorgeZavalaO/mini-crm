...
export const IMPORT_SAMPLE_CSV = [
  ...
  'Acme Logistics SAC,20123456789,Peru,Lima,Lima,Miraflores,"Av. Larco 123, oficina 401",Logistica,Web,2014,120,36,12,Ana Gerente,"Lucia Torres,Mario Lopez","+51 988 111 222,+51 955 000 111","compras@acme.com,operaciones@acme.com","Cliente demo",+51 999 111 222,ventas@acme.com,NEW,admin@acme.com',
  'Importadora Norte,,Peru,Piura,Piura,Castilla,Parque Industrial Mz A Lote 8,Comercio exterior,Referido,2008,85,52,4,Carlos Ruiz,Mario Quispe,+51 944 222 333,comercial@norte.com,"Requiere seguimiento",+51 955 123 456,comercial@norte.com,CONTACTED,',
].join('\n');
...
const COLUMN_ALIASES: Record<string, ImportColumn> = {
  ...
  address: 'address',
  direccion: 'address',
  constitutionyear: 'constitutionYear',
  constitution_year: 'constitutionYear',
  anoconstitucion: 'constitutionYear',
  ano_constitucion: 'constitutionYear',
  employeecount: 'employeeCount',
  employee_count: 'employeeCount',
  trabajadores: 'employeeCount',
  cantidadtrabajadores: 'employeeCount',
  cantidad_trabajadores: 'employeeCount',
  importoperationcount: 'importOperationCount',
  import_operation_count: 'importOperationCount',
  importaciones: 'importOperationCount',
  cantidadimportacion: 'importOperationCount',
  cantidad_importacion: 'importOperationCount',
  operacionesimportacion: 'importOperationCount',
  operaciones_importacion: 'importOperationCount',
  exportoperationcount: 'exportOperationCount',
  export_operation_count: 'exportOperationCount',
  exportaciones: 'exportOperationCount',
  cantidadexportacion: 'exportOperationCount',
  cantidad_exportacion: 'exportOperationCount',
  operacionesexportacion: 'exportOperationCount',
  operaciones_exportacion: 'exportOperationCount',
  industry: 'industry',
  rubro: 'industry',
  source: 'source',
  fuente: 'source',
...
export function mapCsvRecordToImportRow(record: RawCsvRecord, options: MapCsvRecordOptions = {}) {
  ...
  return {
    ...
    constitutionYear: record.constitutionYear || undefined,
    employeeCount: record.employeeCount || undefined,
    importOperationCount: record.importOperationCount || undefined,
    exportOperationCount: record.exportOperationCount || undefined,
